<div class="left-side-menu">
                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu bg-soft-dark" id="side-menu">
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_patient_lab_test.php">Patient's Lab Tests</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_patient_lab_result.php">Patient's Lab Results</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_patient_lab_vitals.php">Patient's Vitals</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_employee_lab_vitals.php">Employee's Vitals</a>
                                    </li>
                                    <li>
