                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h3 class="mb-3">Account Number :  <?php echo $row->acc_number;?></h2>
                                                    <hr>
                                                    <h4 class="text-black"> Account Name : <?php echo $row->acc_name;?></h6>
                                                    <hr>
                                                    <h4 class="text-black">Account Amount : $ <?php echo $row->acc_amount;?> </h6>
                                                    <hr>
                                                    <h4 class="text-black">Account Type :   <?php echo $row->acc_type;?> </h6>
                                                    <hr>
