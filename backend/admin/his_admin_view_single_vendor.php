                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h3 class="mb-3">Vendor Name : <?php echo $row->v_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-black">Vendor Contacts : <?php echo $row->v_phone;?></h3>
                                                    <hr>
                                                    <h4 class="text-black ">Vendor Email : <?php echo $row->v_email;?></h3>
                                                    <hr>
                                                    <h4 class="text-black ">Vendor Address : <?php echo $row->v_adr;?></h3>
                                                    <hr>
