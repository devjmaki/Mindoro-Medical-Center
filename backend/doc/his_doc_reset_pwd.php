...
<head>
        <meta charset="utf-8" />
        <title>MMC - Password Reset </title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="post" >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button name="reset_pwd" class="btn btn-info btn-block" type="submit"> Reset Password </button>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-black-50">Back to <a href="index.php" class="text-info ml-1"><b>Log in</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
