                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img class="mb-3" src="assets/images/logo-header.png" alt="" height="80"></span>
                                    </a>
                                </div>
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-info btn-block" name="doc_login" type="submit"> Login </button>
                                    </div>
