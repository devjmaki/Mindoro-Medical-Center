                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            <div class="float-left">
                                                <img src="assets/images/logo-header.png" alt="" height="80">
                                            </div>
                                                    ...
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                            <td>Php <?php echo $row->pay_emp_salary;?></td>
                                                            <td>16%</td>
                                                            
                                                            <td class="text-right">Php <?php echo $taxable_salary;?></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right">
                                                    <p><b>Sub-total:</b> <span class="float-right">Php <?php echo $row->pay_emp_salary;?></span></p>
                                                    <p><b>Tax (16%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; <?php echo $taxable_salary;?> </span></p>
                                                    <h3>Php <?php echo $total_salary;?></h3>
                                                </div>
