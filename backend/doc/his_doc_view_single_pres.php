                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h3 class="mb-3">Name: <?php echo $row->pres_pat_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-black">Age: <?php echo $row->pres_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h4 class="text-black ">Patient Number: <?php echo $row->pres_pat_number;?></h3>
                                                    <hr>
                                                    <h4 class="text-black ">Patient Category: <?php echo $row->pres_pat_type;?></h3>
                                                    <hr>
                                                    <h4 class="text-black ">Patient Ailment: <?php echo $row->pres_pat_ailment;?></h3>
                                                    <hr>
