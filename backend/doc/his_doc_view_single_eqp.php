                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h3 class="mb-3">Equipment Name: <?php echo $row->eqp_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-black">Equipment Vendor: <?php echo $row->eqp_vendor;?></h4>
                                                    <hr>
                                                    <h4 class="text-black">Equipment Barcode: <?php echo $row->eqp_code;?></h4>
                                                    <hr>
                                                    <h4 class="text-black">Equipment(s) Available: <?php echo $row->eqp_qty;?></h4>
                                                    <hr>
                                                    <h4 class="text-black">Equipment Status: <?php echo $row->eqp_status;?></h4>
                                                    <hr>
                                                    <h4 class="text-black">Equipment Description</h4>
